...
REM Do the copying
win-adb\adb push -p resources/chattr.pie /sdcard/supersu/
win-adb\adb push -p resources/install.sh /sdcard/supersu/
win-adb\adb push -p resources/install-recovery.sh /sdcard/supersu/
win-adb\adb push -p resources/libsupol.so /sdcard/supersu/
win-adb\adb push -p resources/su /sdcard/supersu/
win-adb\adb push -p resources/Superuser.apk /sdcard/supersu/
win-adb\adb push -p resources/supolicy /sdcard/supersu/
