...
# Do the copying
adb push -p  resources/chattr.pie /sdcard/supersu/
adb push -p  resources/install.sh /sdcard/supersu/
adb push -p  resources/install-recovery.sh /sdcard/supersu/
adb push -p  resources/libsupol.so /sdcard/supersu/
adb push -p  resources/su /sdcard/supersu/
adb push -p  resources/Superuser.apk /sdcard/supersu/
adb push -p  resources/supolicy /sdcard/supersu/
