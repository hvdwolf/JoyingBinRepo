...
# on the PX5 we have a install-recovery.sh, so we need to copy the install-recovery_original.sh to install-recovery-2.sh which get called from install-recovery.sh
if [ -f "/system/bin/install-recovery_original.sh" ]; then
  cp /system/bin/install-recovery_original.sh /system/bin/install-recovery-2.sh 1>/dev/null 2>/dev/null
  ch_con /system/bin/install-recovery-2.sh
fi
...
#if [ -f "/system/etc/install-recovery_original.sh" ]; then
#  cp /system/etc/install-recovery.sh /system/etc/install-recovery-2.sh 1>/dev/null 2>/dev/null
#  ch_con /system/etc/install-recovery-2.sh
#fi
